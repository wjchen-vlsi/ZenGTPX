...
public sealed record ZenGtpOptions
{
    ...
    public string ZenTracePath { get; init; } = "";
...
public static class ZenGtpOptionsLoader
{
    ...
    private static ZenGtpOptions ApplyCfgValue(ZenGtpOptions options, string key, string value, int lineNumber)
    {
        return key.ToLowerInvariant() switch
        {
            ...
            "zentracepath" => options with { ZenTracePath = value },
    ...
    private static ZenGtpOptions ApplyCommandLineOverrides(ZenGtpOptions options, string[] args)
    {
        ...
        var overridden = normalized with
        {
            ...
            ZenTracePath = GetArgumentValue(args, "--zenTracePath") ?? normalized.ZenTracePath,
...
internal static class RankPresetTable
{
    ...
    {
        ["6k"] = new("6k", 1000, 0, 1.6, 0.30),
        ["5k"] = new("5k", 1100, 0, 1.4, 0.30),
        ["4k"] = new("4k", 1200, 0, 1.0, 0.30),
        ["3k"] = new("3k", 1300, 1, 2.4, 0.30),
        ["2k"] = new("2k", 1400, 1, 2.0, 0.30),
        ["1k"] = new("1k", 1600, 1, 1.6, 0.30),
        ["1d"] = new("1d", 1800, 1, 1.3, 0.35),
        ["2d"] = new("2d", 2000, 1, 1.0, 0.40),
        ["3d"] = new("3d", 2200, 2, 2.0, 0.45),
        ["4d"] = new("4d", 2400, 2, 1.5, 0.50),
        ["5d"] = new("5d", 2700, 2, 1.0, 0.55),
        ["6d"] = new("6d", 3000, 3, 4.4, 0.60),
        ["7d"] = new("7d", 3500, 3, 2.8, 0.65),
        ["8d"] = new("8d", 4000, 3, 1.4, 0.70),
        ["9d"] = new("9d", 6000, 3, 1.0, 0.75),
    };
